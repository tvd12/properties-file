...
public class FileReaderTest {
    ...
    public void readFileSuccessfully() {
        ...
        InternalFileReader sut = new InternalFileReader(true) {
            @Override
            public Properties loadInputStreamOrThrows(InputStream inputStream, String contentType) throws IOException {
        ...
        // then
        Asserts.assertFalse(actual.isEmpty());
    }
    ...
    @Test
    public void readFileFailedDueToFileNotFound() {
        // given
        InternalFileReader sut = new InternalFileReader(true);

        File file = new File("src/test/resources/application-not-found.yaml");
